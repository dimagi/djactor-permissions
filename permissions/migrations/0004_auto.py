...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Role', fields ['name']
        db.create_index('permissions_role', ['name'])


    def backwards(self, orm):
        
        # Removing index on 'Role', fields ['name']
        db.delete_index('permissions_role', ['name'])
    ...
    models = {
        ...
        'permissions.actor': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'f74ca955c0524c4aae8651c857b455b0'", 'unique': 'True', 'max_length': '32', 'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'permissions.actorgroup': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'e48cc80507cb4d018186bca9edfb96fd'", 'unique': 'True', 'max_length': '32', 'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '160'})
        },
        ...
        'permissions.role': {
            ...
            'id': ('django.db.models.fields.CharField', [], {'default': "'bcd3b02cac1d4538a11c186a22849f45'", 'unique': 'True', 'max_length': '32', 'primary_key': 'True'}),
